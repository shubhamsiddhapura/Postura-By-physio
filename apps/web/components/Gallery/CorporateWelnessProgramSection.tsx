...
function DesktopRepeatTile({
  ...
  return (
    <div
      ref={tileInView.ref}
      className="relative hidden w-full overflow-hidden bg-gray-100 md:col-span-3 md:block md:rounded-none md:rounded-tr-[72px] md:rounded-bl-[72px] md:rounded-tl-[24px] md:rounded-br-[24px]"
      style={{
        opacity: tileInView.isInView ? 1 : 0,
        transform: tileInView.isInView
          ? "translate(0,0)"
